  ...
  return (
    <div className="min-h-screen bg-zinc-50">
        ...
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-5">
            ...
            <nav className="flex items-center gap-4">
              <Link href="/admin" className="text-sm text-zinc-400 hover:text-zinc-700 transition-colors duration-300">
                Предложения
              </Link>
              <Link href="/admin/users" className="text-sm font-semibold text-zinc-900">
                Менеджеры
              </Link>
            </nav>
          </div>
      ...
      <main className="max-w-5xl mx-auto px-6 py-8">
        <div className="mb-6">
          <h1 className="text-lg font-semibold text-zinc-900">Менеджеры</h1>
